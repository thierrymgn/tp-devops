output "vm_ip" {
  value       = module.wordpress.vm_ip
  description = "Container IP on its Docker network"
}

output "vm_name" {
  value       = module.wordpress.vm_name
  description = "Container name"
}

output "vm_id" {
  value       = module.wordpress.vm_id
  description = "Container ID"
}

output "http_port" {
  value       = var.http_port
  description = "Host port where WordPress is reachable (http://<host>:<http_port>)"
}
